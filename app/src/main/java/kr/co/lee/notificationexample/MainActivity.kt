...
class MainActivity : AppCompatActivity() {
    ...
    val buttonClickListener = View.OnClickListener {
        ...
        notificationBuilder?.setLargeIcon(BitmapFactory.decodeResource(resources, R.drawable.img))
        ...
        val broadIntent = Intent(this, NotificationReceiver::class.java)
        ...
        if(it == pictureButton) {
            // Bitmap 생성
            val bigPicture = BitmapFactory.decodeResource(resources, R.drawable.img_1)
